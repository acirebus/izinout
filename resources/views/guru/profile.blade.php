...
@section('title', 'IzinOut - Kelola Profil')
...
<div class="min-h-screen bg-gray-50 p-4 sm:p-6">
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('guru.dashboard') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                Kembali ke Home
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-4 md:p-6">
                ...
                <form id="profileForm" action="{{ route('guru.profile.update') }}" method="POST">
                    @csrf
                    @method('PATCH')
